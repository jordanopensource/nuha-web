export default {
  ...
  methodology: {
    ...
    aboutProjectSubtitle: 'ما هي نهى؟',
  ...
  dashboard: {
    ...
    steps: {
      step1: {
        name: 'قبل أن تبدأ',
        description:
          'نص تحليل النموذج باللغة العربية فقط.\nمن المهم ملاحظة أن نموذج الذكاء الاصطناعي هذا لا يزال تجريبيًا، وقد لا تكون جميع نتائجه واقعية تمامًا.',
      },
      step2: {
        name: 'تحليل النص الخاص بك',
        description: 'أدخل نص باللغة العربية ليتم تحليله.',
        descriptionFile: 'قم بتحميل ملف إذا كان لديك محتوى نصي متعدد.',
        commentPlaceholder: 'أدخل نصًا باللغة العربية...',
      },
    },
    actions: {
      analyze: 'تحليل',
