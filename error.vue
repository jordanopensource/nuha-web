<template>
  <div
    ...
    class="container flex flex-col gap-16 py-16 md:p-16"
  >
    <!-- 404 Content -->
        ...
        <template #title>
          <div class="flex h-full flex-col gap-8">
            <div class="flex flex-col gap-4">
              <h1 class="text-8xl font-extrabold text-colors-primary">
            ...
            <div class="mt-auto flex flex-wrap gap-4 max-sm:justify-center">
              <UiButton size="lg" :to="localePath('/')" variant="primary">
      ...
      <UiPageHeading class="max-md:gap-8">
        <template #title>
          <div class="flex h-full flex-col gap-8">
            ...
            <div class="mt-auto flex flex-wrap gap-4 max-sm:justify-center">
              <UiButton size="lg" variant="primary" @click="handleError">
                {{ $t('error.general.tryAgain') }}
                <template #icon>
                  <Icon name="mdi:refresh" size="24" />
                </template>
              </UiButton>
              <UiButton size="lg" variant="outline" :to="localePath('/')">
